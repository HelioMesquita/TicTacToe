...
Pod::Spec.new do |s|
  s.name             = 'TicTacToe'
  s.version          = '0.1.0'
  s.summary          = 'A short description of TicTacToe.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Helio Mesquita/TicTacToe'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Helio Mesquita' => 'helio.mesquitaios@gmail.com' }
  s.source           = { :git => 'https://github.com/Helio Mesquita/TicTacToe.git', :tag => s.version.to_s }
